...
class SkeletonizedPath(Node):
    def __init__(self):
        ...
        # Declare parameters
        self.declare_parameter('map_image_path', '/home/beta/RINS-beta/src/dis_tutorial3/maps/map.pgm')
        self.declare_parameter('path_topic', '/global_path')
        self.declare_parameter('dilation_pixels', 6)
        self.declare_parameter('resolution', 0.05)  # Map resolution in meters/pixel
        self.declare_parameter('map_origin_x', -2.16)  # Example value, adjust based on your map
        self.declare_parameter('map_origin_y', -2.6)  # Example value, adjust based on your map
    ...
    def generate_skeleton_path(self, image):
        ...
        # Save the modified image to a new file
        output_path_with_points = self.map_image_path.replace('.pgm', '_path_points.pgm')
